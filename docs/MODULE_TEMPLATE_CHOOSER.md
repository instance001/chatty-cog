...
If you are building a new ChattyCog-compatible module, start here.

After you pick a starter, use:

- `docs/MODULE_BUILDER_CHECKLIST.md`
- `docs/MODULE_PACKAGING_GUIDE.md` when you are ready to share it
- `docs/MODULE_REVIEW_RUBRIC.md` for a final quality pass
- `docs/MODULE_RELEASE_NOTES_TEMPLATE.md` if you are publishing an update
- `docs/CHANGELOG_TEMPLATE.md` if you want a running history file

All three starters keep the same core rule:

- your module owns its own UI and state
- ChattyCog only hosts it and reads the optional bridge handoff
