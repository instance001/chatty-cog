...
- Drop the updated module folder into `chattycog_gui/modules/`
- In ChattyCog, use **Modules -> Rescan modules**
...
## Hosted-in-ChattyCog notes

- <Does anything change for hosted use inside ChattyCog?>
...
This update improves the hosted webview UI and gives ChattyCog a cleaner suspend handoff when you leave the tab.
...
- Better layout inside hosted ChattyCog tabs
...
- ChattyCog now receives a better handoff summary on tab leave
