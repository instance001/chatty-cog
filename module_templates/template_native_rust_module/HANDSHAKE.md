...
This starter handshake is for a ChattyCog module.

- If you later want an EDU-safe version, make a separate Chatty-EDU-targeted variant.
...
This starter checks `CHATTYCOG_BRIDGE_STATUS` when hosted inside ChattyCog and writes a short handoff there. Outside ChattyCog it simply ignores the bridge and runs normally.
